...
type RootSyncProgress struct {
	...
	CurrentFolderId    *int64                 `protobuf:"varint,7,opt,name=current_folder_id,json=currentFolderId,proto3,oneof" json:"current_folder_id,omitempty"`
	CurrentPageId      *int64                 `protobuf:"varint,8,opt,name=current_page_id,json=currentPageId,proto3,oneof" json:"current_page_id,omitempty"`
	CurrentPageCount   *int64                 `protobuf:"varint,9,opt,name=current_page_count,json=currentPageCount,proto3,oneof" json:"current_page_count,omitempty"`
	QueueLength        *int64                 `protobuf:"varint,10,opt,name=queue_length,json=queueLength,proto3,oneof" json:"queue_length,omitempty"`
...
func (x *RootSyncProgress) GetCurrentFolderId() int64 {
	if x != nil && x.CurrentFolderId != nil {
		return *x.CurrentFolderId
	}
	return 0
}

func (x *RootSyncProgress) GetCurrentPageId() int64 {
	if x != nil && x.CurrentPageId != nil {
		return *x.CurrentPageId
	}
	return 0
}

func (x *RootSyncProgress) GetCurrentPageCount() int64 {
	if x != nil && x.CurrentPageCount != nil {
		return *x.CurrentPageCount
	}
	return 0
}

func (x *RootSyncProgress) GetQueueLength() int64 {
...
func (x *RootSyncProgress) GetError() string {
...
const file_npan_v1_api_proto_rawDesc = "" +
	...
	"\vended_at_ts\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\tendedAtTs\"\xda\x04\n" +
	...
	"\rupdated_at_ts\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vupdatedAtTs\x12/\n" +
	"\x11current_folder_id\x18\a \x01(\x03H\x01R\x0fcurrentFolderId\x88\x01\x01\x12+\n" +
	"\x0fcurrent_page_id\x18\b \x01(\x03H\x02R\rcurrentPageId\x88\x01\x01\x121\n" +
	"\x12current_page_count\x18\t \x01(\x03H\x03R\x10currentPageCount\x88\x01\x01\x12&\n" +
	"\fqueue_length\x18\n" +
	" \x01(\x03H\x04R\vqueueLength\x88\x01\x01\x12\x19\n" +
	"\x05error\x18\v \x01(\tH\x05R\x05error\x88\x01\x01B\x17\n" +
	"\x15_estimated_total_docsB\x14\n" +
	"\x12_current_folder_idB\x12\n" +
	"\x10_current_page_idB\x15\n" +
	"\x13_current_page_countB\x0f\n" +
	"\r_queue_lengthB\b\n" +
	"\x06_error\"\x8f\x02\n" +
	...
	"\x06_meili\"\x18\n" +
	"\x16GetSearchConfigRequest\"\xc3\x01\n" +
	...
	"\x15instantsearch_enabled\x18\x04 \x01(\bR\x14instantsearchEnabled\x12\x1a\n" +
	"\bprovider\x18\x05 \x01(\tR\bprovider\"\x8e\x01\n" +
